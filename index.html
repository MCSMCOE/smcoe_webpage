...
<body>
  ...
  <div class="intro intro-carousel swiper position-relative">
    ...
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide carousel-item-a intro-item bg-image" style="background-image: url('https://webdocs.pages.dev/assets/img/ece/ece.jpg')">
      ...
      <div class="swiper-slide carousel-item-a intro-item bg-image" style='background-image: url("https://webdocs.pages.dev/assets/img/eee/eee.jpg");' >
        <div class="overlay overlay-a"></div>
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="container">
      ...
      <div class="swiper-slide carousel-item-a intro-item bg-image"  style='background-image: url("https://webdocs.pages.dev/assets/img/mech/mech.jpg");'>
        <div class="overlay overlay-a"></div>
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="container">
