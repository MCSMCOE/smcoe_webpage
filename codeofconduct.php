    ...
    <section id="resume" class="resume">
        <div class="container">
          ...
          <div class="section-title">
            <h2>Code of Conduct</h2>
            <p>Student is required to observe discipline and decorous behaviour both inside and outside the college and not to indulge in any activity, which will tend to bring down the prestige of the University/college.</p>
          </div>
          ...
          <div class="row">
            <div class="col-lg-6" data-aos="fade-up">
              ...
              <div class="resume-item pb-0">
                ...
                <ul>
                  <li>College Timing is 9.00 a.m. to 4.20 p.m. Students should attend all classes regularly and punctually.The college bus will leave the campus by 4.30 p.m.</li>
                  ...
                  <li>To achieve discipline and uniformity among students,the uniform is insisted on campus. Wearing an overcoat is a must for Workshop and laboratory classes as per the safety rules.</li>
                  ...
                  <li>In case of Parents/Guardians meeting being conducted to discuss various issues of students, Parents/Guardians must attend without fail. Healthy co-operation in this regard is ever solicited.</li>
                  <li>Students can take part in inter - college competitions and TV/Radio programmes, only after getting prior permission from the authorities concerned.</li>
                  <li>Strict discipline should be maintained on the College campus. Non-compliance with the guidelines or regulations of the college will be severely dealt with.</li>
                </ul>
              </div>
              ...
              <div class="resume-item">
                ...
                <ul>
                    ...
                    <li>To maintain the dress code.</li>
                    <li>Boys are not supposed to wear unnecessary wearing on their ears, neck and hands.</li>
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="resume-item">
                ...
                <ul>
                  ...
                  <li>The teacher should avoid the discrimination of caste, creed or religion race or sex with the students and his/her colleagues.</li>
                  <li>The teacher should obey the conditions of the concerned authorities, officers, administrative and academic departments of the college.</li>
                  ...
                  <li>Teachers are eligible for leave as per the prevailing rules laid down by the Management from time to time.</li>
                  </ul>
              </div>
              <div class="resume-item">
                ...
                <ul>
                  ...
                  <li>The students should not loiter on the college premises when the classes are in progress. When they are free, they should make use of the college library.</li>
                  ...
                  <li>The management reserves the right to expel from the college any student on grounds of serious irregularity of attendance, insubordination, malpractice in examination or any other act of indiscipline or misconduct. The decision of the college authorities in this regard shall be final.</li>
                  <li>Students are required to maintain not only good academic progress but also high discipline on the campus.</li>
                  <li>Students are advised to be present on the campus 10 minutes before the start of the morning session.</li>
                  ...
                  <li>Damaging the desk, bench, electrical item, switch board etc in the class room will lead to a penalty for the respective class.</li>
                </ul>
              </div>
            </div>
            <div class="col-lg-6" data-aos="fade-up">
                ...
                <div class="resume-item pb-0">
                  ...
                  <ul>
                    ...
                    <li>Must follow the communications and decisions received from the University, Government, AICTE etc.</li>
                    ...
                    <li>Should ponder into the income and expenditure of the college from time to time.</li>
                </ul>
                </div>
          </div>
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <h3 class="resume-title">Principal</h3>
            <p><em>The Principal is the head and the sole responsible person for addressing and solving the issues concerned with education as well as all the activities of the college.</em></p>
            <div class="resume-item">
              <!--<h4>Senior graphic design specialist</h4>
              <h5>2019 - Present</h5>
              <p><em>Experion, New York, NY </em></p>-->
              <ul>
                ...
                <li>Guiding the Staff in planning and activation of academic training programmes like bridge course, value-added courses, seminars etc.</li>
                ...
                <li>Maintenance of the records related to academic, non-academic, university, AICTE etc.</li>
                <li>Supervising the Examinations both at the internal and university level.</li>
                 </ul>
            </div>
        </div>
